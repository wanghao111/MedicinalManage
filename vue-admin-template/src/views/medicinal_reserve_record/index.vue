    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="库存类型"  align="center">
          <template slot-scope="scope">
            {{convertReserveType(scope.row.reserveType)}}
          </template>
        </el-table-column>
         <el-table-column label="库存操作时间"  align="center">
          <template slot-scope="scope">
...
<script>
import { getReserveRecordList} from '@/api/medicinal'
...
export default {
  ...
  methods: {
    fetchData(p) {
      ...
      getReserveRecordList(pageQuery).then(response => {
